		...
		<div class="main-menu-content">
			<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				<li class=" nav-item {{ (request()->routeIs('home'))? 'active' : '' }}">
                    <a href="{{ route('home') }}"><i class="la la-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
				</li>
                <li class=" nav-item {{ request()->routeIs('nutritionist.index') || request()->routeIs('nutritionist.create') || request()->routeIs('nutritionist.show') ? 'open' : '' }}">
                    <a href="#"><i class="la la-user-plus"></i><span class="menu-title" data-i18n="Templates">Nutritionists</span></a>
                    <ul class="menu-content">
                        <li class="{{ ( request()->routeIs('nutritionist.create')) ? 'active' : '' }}"><a class="menu-item" href="{{ route('nutritionist.create') }}"><i></i><span data-i18n="Vertical">Add Nutritionist</span></a></li>
                        <li class="{{ (request()->routeIs('nutritionist.index') || request()->routeIs('nutritionist.show') )? 'active' : '' }}"><a class="menu-item" href="{{ route('nutritionist.index') }}"><i></i><span data-i18n="Horizontal">Nutritionist List</span></a></li>
                    </ul>
                </li>
                <li class=" nav-item {{ request()->routeIs('clients.index') || request()->routeIs('clients.create') ? 'open' : '' }}">
                    <a href="#"><i class="la la-users"></i><span class="menu-title" data-i18n="Templates">Clients</span></a>
                    <ul class="menu-content">
                        <li class="{{ (request()->routeIs('clients.create'))? 'active' : '' }}"><a class="menu-item" href="{{ route('clients.create') }}"><i></i><span data-i18n="Vertical">Add Client</span></a></li>
                        <li class="{{ (request()->routeIs('clients.index'))? 'active' : '' }}"><a class="menu-item" href="{{ route('clients.index') }}"><i></i><span data-i18n="Horizontal">Client List</span></a></li>
                    </ul>
                </li>
			</ul>
		</div>
